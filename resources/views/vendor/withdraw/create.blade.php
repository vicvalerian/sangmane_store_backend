        ...
        $(document).ready(function() {
            $('#method').on('change', function(e) {
                ...
                $.ajax({
                    ...
                    <h6>Payout Range: {{ $settings->currency_icon }}${response.minimum_amount} - {{ $settings->currency_icon }}${response.maximum_amount}</h6>
                    <h6>Withdraw Charge: ${response.withdraw_charge}%</h6>
