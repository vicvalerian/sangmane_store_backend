                ...
                @if ($productpage_banner_section->banner_one->status == 1)
                    <div class="col-xl-12">
                        <div class="wsus__pro_page_bammer">
                            <img src="{{ $productpage_banner_section->banner_one->banner_image }}" alt="banner"
                                                    ...
                                                    <ul class="wsus__single_pro_icon">
                                                        <form class="shopping-cart-form">
                                                            ...
                                                            @foreach ($product->product_variants as $variant)
                                                                ...
                                                                @endif
                                                            @endforeach
                                                            <button type="submit" class="add_cart_two mr-2">Add to
                                                                Cart</button>
                                                        </form>
                                                        <li><a href="#" class="add_to_wishlist"
                                                                data-id="{{ $product->id }}"><i
                                        ...
                                        <div class="row modal_slider">
                                            <div class="col-xl-12">
                                                <div class="modal_slider_img">
                                                    <img class="img-fluid w-100" src="{{ asset($product->thumb_image) }}"
                                                        alt="product">
                                                </div>
                                            </div>
                                            @if (count($product->product_image_galleries) == 0)
                                                <div class="col-xl-12">
                                                    <div class="modal_slider_img">
