...
class HomePageSettingController extends Controller
{
    ...
    public function updatePopularCategorySection(Request $request)
    {
        ...
        toastr('Popular Category Section Updated successfully!', 'success', 'success');
    ...
    public function updateProductSliderSectionOne(Request $request)
    {
        ...
        toastr('Product Slider Section One Updated Successfully!', 'success', 'success');
    ...
    public function updateProductSliderSectionTwo(Request $request)
    {
        ...
        toastr('Product Slider Section Two Updated Successfully!', 'success', 'success');
    ...
    public function updateProductSliderSectionThree(Request $request)
    {
        ...
        toastr('Product Slider Section Three Updated Successfully!', 'success', 'success');
